...
export const BATTERY_TRAY = {
  ...
  description: {
    pl: 'Pobierz z umdrivers.com/tray: lekki, podpisany EV .exe z poziomem baterii w trayu Windows i opcjonalnym widgetem. Native: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT. Katalog OpenMouse: wykrywanie wszystkich VID:PID; % baterii gdy OpenMouse ma ścieżkę HID (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic); inaczej n/a.',
    en: 'Download from umdrivers.com/tray: a light EV-signed Windows .exe for system-tray battery and an optional desktop widget. Native: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT. OpenMouse catalog: detects every listed VID:PID; battery % when OpenMouse exposes a HID path (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic); otherwise n/a.',
    de: 'Download auf umdrivers.com/tray: eine schlanke, EV-signierte Windows-.exe mit Akkustand im Infobereich und optionalem Desktop-Widget. Nativ: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT. OpenMouse-Katalog: erkennt alle gelisteten VID:PID; Akkustand bei HID-Pfad (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic); sonst n/a.',
    fr: 'À télécharger sur umdrivers.com/tray : un .exe Windows léger, signé EV, qui affiche la batterie dans la zone de notification et dans un widget de bureau facultatif. Natif : King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT. Catalogue OpenMouse : détecte chaque VID:PID listé ; % batterie si chemin HID (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic) ; sinon n/a.',
    es: 'Descárgalo en umdrivers.com/tray: un .exe ligero para Windows, firmado con certificado EV, que muestra la batería en la bandeja del sistema y en un widget de escritorio opcional. Nativo: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT. Catálogo OpenMouse: detecta cada VID:PID listado; % de batería con ruta HID (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic); si no n/a.',
    pt: 'Transfira em umdrivers.com/tray: um .exe leve para Windows, assinado com certificado EV, que mostra a bateria na área de notificação e num widget opcional no ambiente de trabalho. Nativo: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT. Catálogo OpenMouse: deteta cada VID:PID listado; % de bateria com caminho HID (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic); senão n/a.',
    it: 'Scaricalo da umdrivers.com/tray: un .exe leggero per Windows, firmato EV, che mostra la batteria nell’area di notifica e in un widget desktop opzionale. Nativo: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT. Catalogo OpenMouse: rileva ogni VID:PID elencato; % batteria con percorso HID (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic); altrimenti n/a.',
    zh: '从 umdrivers.com/tray 下载：轻量且带 EV 签名的 Windows .exe，可在系统托盘中显示电量，并提供可选桌面小组件。原生：King Ultra、Blitz Ultimate、Fenrir Max、PRO X SUPERLIGHT。OpenMouse 目录：检测所有列出的 VID:PID；有 HID 电量路径时显示 %（G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic）；否则 n/a。',
    ja: 'umdrivers.com/tray からダウンロード：軽量で EV 署名済みの Windows .exe。システムトレイにバッテリー残量を表示し、オプションのデスクトップウィジェットも利用できます。ネイティブ：King Ultra、Blitz Ultimate、Fenrir Max、PRO X SUPERLIGHT。OpenMouse カタログ：掲載の全 VID:PID を検出。HID 経路がある場合に残量（G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic）；それ以外は n/a。',
    ko: 'umdrivers.com/tray에서 다운로드하세요. 가볍고 EV 서명된 Windows .exe로 시스템 트레이에 배터리를 표시하며 선택 사항인 데스크톱 위젯도 제공합니다. 네이티브: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT. OpenMouse 카탈로그: 등록된 모든 VID:PID 감지. HID 경로가 있으면 잔량 (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic); 그 외 n/a.',
    ru: 'Скачайте с umdrivers.com/tray: лёгкий Windows .exe с EV-подписью, который показывает заряд в системном трее и дополнительном виджете рабочего стола. Нативно: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT. Каталог OpenMouse: обнаруживает все перечисленные VID:PID; % заряда при HID-пути (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic); иначе n/a.',
  },
  eyebrow: {
    pl: 'Windows .exe',
    en: 'Windows .exe',
    ...
    },
    {
      ...
      bullets: {
        pl: [
          ...
          'Wybór myszy: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT + OpenMouse (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic; inne n/a)',
        ...
        en: [
          ...
          'Mouse picker: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT + OpenMouse (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic; others n/a)',
        ...
        de: [
          ...
          'Mausauswahl: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT + OpenMouse (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic; sonst n/a)',
        ...
        fr: [
          ...
          'Sélection de la souris : King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT + OpenMouse (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic ; sinon n/a)',
        ...
        es: [
          ...
          'Selector de ratón: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT + OpenMouse (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic; si no n/a)',
        ...
        pt: [
          ...
          'Seletor de rato: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT + OpenMouse (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic; senão n/a)',
        ...
        it: [
          ...
          'Selezione del mouse: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT + OpenMouse (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic; altrimenti n/a)',
        ...
        zh: [
          ...
          '可选桌面小组件（始终置顶、透明度、尺寸）',
          '鼠标选择：King Ultra、Blitz Ultimate、Fenrir Max、PRO X SUPERLIGHT + OpenMouse (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic；其余 n/a)',
        ...
        ja: [
          ...
          'マウス選択：King Ultra、Blitz Ultimate、Fenrir Max、PRO X SUPERLIGHT + OpenMouse (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic；他 n/a)',
        ...
        ko: [
          ...
          '마우스 선택: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT + OpenMouse (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic; 그 외 n/a)',
        ...
        ru: [
          ...
          'Выбор мыши: King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT + OpenMouse (G-Wolves, Logitech, VGN/Pulsar/ATK/Teevolution, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic; иначе n/a)',
