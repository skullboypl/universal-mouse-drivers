...
const en: Dict = {
  ...
  'connect.trayBody':
    'Optional EV-signed .exe when you want battery % in the Windows tray without keeping the browser open. Works with King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT, and OpenMouse catalog mice with HID battery codecs (G-Wolves, Logitech, VGN/Pulsar/ATK, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic; else n/a).',
...
const pl: Dict = {
  ...
  'connect.trayTitle': 'UMD Battery Tray',
  'connect.trayBody':
    'Opcjonalny, podpisany EV .exe, gdy chcesz poziom baterii w trayu Windows bez otwartej przeglądarki. Działa z King Ultra, Blitz Ultimate, Fenrir Max, PRO X SUPERLIGHT oraz katalogiem OpenMouse z kodekami baterii HID (G-Wolves, Logitech, VGN/Pulsar/ATK, Lamzu, SteelSeries, Razer, Keychron, K-snake, WALLHACK, MCHOSE, Ninjutso, Glorious Classic; inaczej n/a).',
